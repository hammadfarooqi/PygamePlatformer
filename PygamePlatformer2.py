...
"""
import pygame
from PygamePlatformer2Levels import *
...
grass = pygame.image.load('Environment/GrassBlock.png').convert_alpha()
dirt = pygame.image.load('Environment/DirtBlock.png').convert()
brick = pygame.image.load('Environment/Brick.png').convert()
brickFloor = pygame.image.load('Environment/BrickFloor.png').convert()
# spike = pygame.image.load('Environment/Spike.png').convert_alpha()

heart = pygame.image.load('Man/Heart.png').convert_alpha()
runRight = [pygame.image.load('Man/Running/RRun1.png').convert_alpha(), pygame.image.load('Man/Running/RRun2.png').convert_alpha(), pygame.image.load('Man/Running/RRun3.png').convert_alpha(), pygame.image.load('Man/Running/RRun4.png').convert_alpha(), pygame.image.load('Man/Running/RRun5.png').convert_alpha()]
runLeft = [pygame.image.load('Man/Running/LRun1.png').convert_alpha(), pygame.image.load('Man/Running/LRun2.png').convert_alpha(), pygame.image.load('Man/Running/LRun3.png').convert_alpha(), pygame.image.load('Man/Running/LRun4.png').convert_alpha(), pygame.image.load('Man/Running/LRun5.png').convert_alpha()]
idleRight = [pygame.image.load('Man/Idle/RIdle1.png').convert_alpha(), pygame.image.load('Man/Idle/RIdle2.png').convert_alpha(), pygame.image.load('Man/Idle/RIdle3.png').convert_alpha(), pygame.image.load('Man/Idle/RIdle4.png').convert_alpha()]
idleLeft = [pygame.image.load('Man/Idle/LIdle1.png').convert_alpha(), pygame.image.load('Man/Idle/LIdle2.png').convert_alpha(), pygame.image.load('Man/Idle/LIdle3.png').convert_alpha(), pygame.image.load('Man/Idle/LIdle4.png').convert_alpha()]
jumpRight = [pygame.image.load('Man/Jumping/RUp.png').convert_alpha(), pygame.image.load('Man/Jumping/RDown.png').convert_alpha()]
jumpLeft = [pygame.image.load('Man/Jumping/LUp.png').convert_alpha(), pygame.image.load('Man/Jumping/LDown.png').convert_alpha()]
...
baddyIdleRight = [pygame.image.load('Baddy/Idle/RIdle1.png').convert_alpha(), pygame.image.load('Baddy/Idle/RIdle2.png').convert_alpha(), pygame.image.load('Baddy/Idle/RIdle3.png').convert_alpha(), pygame.image.load('Baddy/Idle/RIdle4.png').convert_alpha()]
baddyIdleLeft = [pygame.image.load('Baddy/Idle/LIdle1.png').convert_alpha(), pygame.image.load('Baddy/Idle/LIdle2.png').convert_alpha(), pygame.image.load('Baddy/Idle/LIdle3.png').convert_alpha(), pygame.image.load('Baddy/Idle/LIdle4.png').convert_alpha()]
...
globIdleLeft = [pygame.image.load('GlobMonster/Idle/LIdle1.png').convert_alpha(), pygame.image.load('GlobMonster/Idle/LIdle2.png').convert_alpha(), pygame.image.load('GlobMonster/Idle/LIdle3.png').convert_alpha(), pygame.image.load('GlobMonster/Idle/LIdle4.png').convert_alpha(), pygame.image.load('GlobMonster/Idle/LIdle5.png').convert_alpha()]
globDeath = [pygame.image.load('GlobMonster/Death/Death1.png').convert_alpha(), pygame.image.load('GlobMonster/Death/Death2.png').convert_alpha(), pygame.image.load('GlobMonster/Death/Death3.png').convert_alpha()]
globAttackIdle = [pygame.image.load('GlobMonster/Attack/Idle1.png').convert_alpha(), pygame.image.load('GlobMonster/Attack/Idle2.png').convert_alpha(), pygame.image.load('GlobMonster/Attack/Idle3.png').convert_alpha(), pygame.image.load('GlobMonster/Attack/Idle4.png').convert_alpha()]
...
botIdleRight = [pygame.image.load('Bot/Idle/RIdle1.png').convert_alpha(), pygame.image.load('Bot/Idle/RIdle2.png').convert_alpha(), pygame.image.load('Bot/Idle/RIdle3.png').convert_alpha()]
botIdleLeft = [pygame.image.load('Bot/Idle/LIdle1.png').convert_alpha(), pygame.image.load('Bot/Idle/LIdle2.png').convert_alpha(), pygame.image.load('Bot/Idle/LIdle3.png').convert_alpha()]
botTalkRight = [pygame.image.load('Bot/Talking/RTalk1.png').convert_alpha(), pygame.image.load('Bot/Talking/RTalk2.png').convert_alpha(), pygame.image.load('Bot/Talking/RTalk3.png').convert_alpha()]
botTalkLeft = [pygame.image.load('Bot/Talking/LTalk1.png').convert_alpha(), pygame.image.load('Bot/Talking/LTalk2.png').convert_alpha(), pygame.image.load('Bot/Talking/LTalk3.png').convert_alpha()]
...
class baddy():
    ...
    def draw(self, win, worldNum, levelNum):
...
class glob():
    ...
    def draw(self, levelNum, worldNum):
    ...
    def drawHealth(self, levelNum, worldNum):
        if self.start:
    ...
    def attack(self, levelNum, worldNum):
        if self.start:
...
def refresh(worldNum, levelNum, bgCount):
    ...
    for badGuy in badGuys:
        badGuy.draw(win, worldNum, levelNum)
    man.draw(win)
    glob.draw(levelNum, worldNum)
    glob.drawHealth(levelNum, worldNum)
    glob.attack(levelNum, worldNum)
...
def runGame(bgCount, worldNum, levelNum, bullets, bulletsNum):
    ...
    while run:
        ...
        refresh(worldNum, levelNum, bgCount)
